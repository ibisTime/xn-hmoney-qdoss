...
import {
    ...
    moneyParse, getRules, getRealValue
} from 'common/js/util';
import fetch from 'common/js/fetch';
import {
    UPLOAD_URL, PIC_PREFIX, PIC_BASEURL_L, tailFormItemLayout, tailFormItemLayout1,
    validateFieldsAndScrollOption, DATE_FORMAT, MONTH_FORMAT, DATETIME_FORMAT
