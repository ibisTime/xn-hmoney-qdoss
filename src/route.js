...
const ROUTES = [
    ...
    // 佣金明细
    {
        path: '/myFriend/directRecommend/commissions',
    ...
    // 佣金明细
    {
        path: '/myFriend/inDirectRecommend/commissions',
        component: asyncComponent(() => import('container/inviteFriends/myFriend/directRecommend-addedit'))
    },
    // 账户查询 -- 账户查询
    {
    ...
    // 提币
    {
        path: '/account/account/mentionMoney',
        component: asyncComponent(() => import('container/bonusManagement/account/account-mentionMoney'))
    },
    // 资金流水
    {
        path: '/account/account/ledger',
